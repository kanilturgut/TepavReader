...
public class FavoriteListAdapter extends ArrayAdapter<DBData> {
    ...
    public FavoriteListAdapter(Context context, SwipeListView swipeListView, LinkedList<DBData> dbDataList) {
        ...
        holder.frontOfFavoriteClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (intent != null) {
                    ...
                    intent.putExtra("listType", QuickActionForList.LIST_TYPE_FAVORITES);
